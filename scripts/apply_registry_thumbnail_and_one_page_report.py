...
# Preserve mandatory visual + optional AI summary fields in public registry payload.
...
anchor = '            copyIfPresent(fullMetadata, this, "thumbnailJpegBase64")\n'
extra = '''            copyIfPresent(fullMetadata, this, "thumbnailSha256")
            copyIfPresent(fullMetadata, this, "thumbnailMimeType")
            copyIfPresent(fullMetadata, this, "visualEvidenceRequired")
            copyIfPresent(fullMetadata, this, "aiVisualSummary")
            copyIfPresent(fullMetadata, this, "aiLikelyPurpose")
            copyIfPresent(fullMetadata, this, "aiSummaryModel")
            copyIfPresent(fullMetadata, this, "aiSummaryGeneratedAt")
'''
if 'copyIfPresent(fullMetadata, this, "thumbnailSha256")' not in s:
    s = s.replace(anchor, anchor + extra)
outbox.write_text(s, encoding='utf-8')

# One-page report. Every fact is rendered once; machine checks are separated from recorded data.
...
print('Applied: mandatory registry visual fields + one-page structured forensic report with machine verification.')
